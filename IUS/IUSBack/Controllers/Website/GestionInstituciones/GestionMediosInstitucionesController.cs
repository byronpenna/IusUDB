...
namespace IUSBack.Controllers
{
    public class GestionMediosInstitucionesController : PadreController
    {
        ...
        #region "acciones url"
            public ActionResult Index(int id=-1)
            {
                ...
                try
                {
                    ...
                    ViewBag.emails      = this._model.sp_frontui_getEmailInstitucion(institucion._idInstitucion,usuarioSession._idUsuario,this._idPagina);
        ...
        #region "acciones ajax"
            // correo electronico
                public ActionResult sp_frontui_eliminarEmailInstitucion()
                {
                    ...
                    try
                    {
                        ...
                        if (respuesta == null)
                        {
                            ...
                            bool estado = this._model.sp_frontui_eliminarEmailInstitucion(this.convertObjAjaxToInt(frm["txtHdIdEmailInstitucion"]), usuarioSession._idUsuario, this._idPagina);
                ...
                public ActionResult sp_frontui_agregarEmailInstitucion()
                {
                    Dictionary<object, object> frm, respuesta = null;
                    try
                    {
